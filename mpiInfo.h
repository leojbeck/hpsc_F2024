...
class mpiInfo
{
 public:
  ...
  void ParticleExchange( VI &ptcl_send_list , VI &ptcl_send_PE , particles &PTCL)
  {
    ...
    MPI_Iallreduce( /* TO-DO in Lab */ ,   /* TO-DO in Lab */ , 1 , MPI_INT, /* TO-DO in Lab */ , MPI_COMM_WORLD, &request);  MPI_Wait(&request,&status); 
    ...
    MPI_Iallgather( /*  TO-DO in Lab */ , &request);  MPI_Wait(&request,&status);  
    MPI_Iallgather( /*  TO-DO in Lab */ , &request);  MPI_Wait(&request,&status);  
    MPI_Iallgather( /*  TO-DO in Lab */ , &request);  MPI_Wait(&request,&status);  
    MPI_Iallgather( /*  TO-DO in Lab */ , &request);  MPI_Wait(&request,&status);  
    MPI_Iallgather( /*  TO-DO in Lab */ , &request);  MPI_Wait(&request,&status);  
